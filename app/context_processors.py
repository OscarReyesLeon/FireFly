...
def pedidos_status(request):
    ...
    dia9di = Pedido.objects.filter(fc__year=ano9,fc__month=mes9,fc__day=dia9,status="Directa").count()
    ...
    dia10di = Pedido.objects.filter(fc__year=ano10,fc__month=mes10,fc__day=dia10,status="Directa").count()
    ...
    dia11di = Pedido.objects.filter(fc__year=ano11,fc__month=mes11,fc__day=dia11,status="Directa").count()
    ...
    dia12di = Pedido.objects.filter(fc__year=ano12,fc__month=mes12,fc__day=dia12,status="Directa").count()
    ...
    dia13di = Pedido.objects.filter(fc__year=ano13,fc__month=mes13,fc__day=dia13,status="Directa").count()
    ...
    dia14di = Pedido.objects.filter(fc__year=ano14,fc__month=mes14,fc__day=dia14,status="Directa").count()
    ...
    dia15di = Pedido.objects.filter(fc__year=ano15,fc__month=mes15,fc__day=dia15,status="Directa").count()
