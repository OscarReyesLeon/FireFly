    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_order', models.CharField(help_text='Folio que está aociado al pédido', max_length=50, unique=True, verbose_name='Folio del pedido')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Remisión (Ingreso)'), (2, 'Autorización y asignación de camión'), (3, 'Cáptura de salida'), (4, 'Salida del almacén'), (5, 'Entregado'), (6, 'Entrada a almacén'), (7, 'Cáptura de entrada'), (8, 'Finalizado')], default=1, help_text='Estatus del pedido', verbose_name='Estatus del pedido')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('liters', models.FloatField(blank=True, default=0, help_text='Litros de combustible que se utilizaron en el traslado', null=True, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='Litros de combustible')),
                ('driver', models.ForeignKey(help_text='Conductor que realizará el traslado', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='driver_transfer', to=settings.AUTH_USER_MODEL, verbose_name='Conductor')),
                ('order', models.OneToOneField(help_text='Pedido al que pertenece el traslado', on_delete=django.db.models.deletion.CASCADE, related_name='order_transfer', to='orders.ordermodel', verbose_name='Pedido')),
                ('pump', models.ForeignKey(blank=True, help_text='Bombas de combustible que se utilizará', null=True, on_delete=django.db.models.deletion.PROTECT, to='administration.fuelpumpmodel', verbose_name='Bombas de combustible que se utilizará')),
                ('user_create', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transfermodel_user_create', to=settings.AUTH_USER_MODEL)),
                ('user_update', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transfermodel_user_update', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.transfermodel')),
                ('user_create', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='logtrasnfermodel_user_create', to=settings.AUTH_USER_MODEL)),
                ('user_update', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='logtrasnfermodel_user_update', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_transfer', models.FloatField(default=0, help_text='Cantidad a trasladar', validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='Cantidad a trasladar')),
                ...
                ('truck', models.ForeignKey(help_text='Remolque que se utilizará en el traslado', on_delete=django.db.models.deletion.PROTECT, related_name='truck_detail_transfer', to='administration.truckvehiclemodel', verbose_name='Remolque que se utilizará')),
