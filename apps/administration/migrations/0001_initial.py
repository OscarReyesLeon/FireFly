# Generated by Django 3.2 on 2023-03-09 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(help_text='Nombre de la categoría a la que pertenecerá el producto', max_length=50, unique=True)),
                ('description', models.CharField(blank=True, help_text='Breve descripción de la categoría que indique su propósito', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsible', models.ForeignKey(blank=True, help_text='Chofer responsable del vehiculo (Opcional)', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Chofer responsable')),
